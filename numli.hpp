...
/**************************************************************************//**
 * Algebra
 * @brief Various algebraic structures.
 *****************************************************************************/
namespace bra {
// Contains:
...
/**************************************************************************//**
 * Computer Graphics
 * @brief Provides commonly used structures and loading utilities.
 * 
 * @see Ray
 * @see Mesh
 * @see loadPLY
...
// Aliases:
  using vec3 = bra::NdReal<3, double>;      /** A 3d vector. */
  using vec4 = bra::NdReal<4, double>;      /** A vector in the space PG2. */
  using point3 = bra::NdReal<3, double>;    /** A 3d point. */
  using point4 = bra::NdReal<4, double>;    /** A point in the space PG2. */
  using color = bra::NdReal<3, uint8_t>;    /** An rgb colour (0 to 255).*/
