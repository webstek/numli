...
| Materials     | `material` | array of: `name: C`, with `C`:<br> `type: type_params...`
| material types:| `lambertian`<br> `blinn`<br> `microfacet` | `albedo: [3]`<br> `Kd: [3], Ks: [3], Kt: [3], roughness: x, reflect: [3], Le: [3]`<br> `...`
| Transformation| `transformation` | array of: `type: type_params...`
| transformation types: | `translate`<br> `scale`<br> `rotate` | `[3]`<br> `[3]`<br> `axis: [3], degrees: x`
| Objects       | `objects`  | array of `name: C`, with `C`:<br> `type: type_params...`
...
| Lights        | `lights`   | array of: `"name": C`, with `C`:<br> `type: type_params...`
